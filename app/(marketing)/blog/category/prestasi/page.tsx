...
export default function PrestasiCategoryPage() {
  const category = getCategoryById("prestasi");
  const posts = getPostsByCategory("prestasi");
      ...
      <div className="border-b border-gray-200 px-4 py-8 md:py-12">
        <div className="container mx-auto">
          ...
          <p className="mt-2 text-gray-600">
            Artikel tentang pencapaian, penghargaan, dan kesuksesan siswa
          </p>
