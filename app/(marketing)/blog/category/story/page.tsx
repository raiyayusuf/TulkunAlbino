/* ============================================
   app/(marketing)/blog/category/story/page.tsx
   STORY CATEGORY PAGE - GSE JOGJA
   ============================================ */
...
/* ============================================
   STORY CATEGORY PAGE COMPONENT
   ============================================ */
export default function StoryCategoryPage() {
  /* ============================================
     DATA FETCHING
     ============================================ */
  const category = getCategoryById("story");
      ...
      <div className="border-b border-gray-200 px-4 py-8 md:py-12">
        <div className="container mx-auto">
          ...
          <p className="mt-2 text-gray-600">
            Cerita inspiratif, pengalaman siswa, dan kisah sukses
          </p>
