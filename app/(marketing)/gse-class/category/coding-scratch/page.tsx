/* ============================================
   app/(marketing)/gse-class/category/coding-scratch/page.tsx
   CODING SCRATCH COURSE DETAIL PAGE
   ============================================ */
...
/* ============================================
   CODING SCRATCH PAGE COMPONENT
   ============================================ */
export default function CodingScratchPage() {
  /* ============================================
     COURSE DETAILS
     ============================================ */
  const courseDetails = {
    title: "Coding Scratch",
    description: "Belajar pemrograman visual dengan Scratch untuk pemula",
    features: [
      "Pengenalan logika pemrograman",
      "Membuat game dan animasi interaktif",
      "Konsep percabangan dan perulangan",
      "Penggunaan variabel dan data",
      "Project game sederhana yang menarik",
    ],
  };
