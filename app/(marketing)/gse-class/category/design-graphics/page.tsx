/* ============================================
   app/(marketing)/gse-class/category/design-graphics/page.tsx
   DESIGN GRAPHICS COURSE DETAIL PAGE
   ============================================ */
...
/* ============================================
   DESIGN GRAPHICS PAGE COMPONENT
   ============================================ */
export default function DesignGraphicsPage() {
  ...
  const courseDetails = {
    ...
    description: "Belajar desain grafis untuk media digital dan cetak",
    features: [
      "Dasar-dasar desain dan prinsip visual",
      "Penggunaan software desain grafis",
      "Tipografi dan layout design",
      "Color theory dan psychology",
      "Membuat branding dan media promosi",
    ],
  };
