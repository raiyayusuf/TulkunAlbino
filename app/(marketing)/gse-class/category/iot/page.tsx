/* ============================================
   app/(marketing)/gse-class/category/iot/page.tsx
   IOT COURSE DETAIL PAGE
   ============================================ */
...
export default function IoTPage() {
  ...
  const courseDetails = {
    ...
    description: "Belajar membuat sistem dan perangkat IoT dari nol",
    features: [
      "Pengenalan konsep IoT dan arsitektur",
      "Pemrograman mikrokontroler (Arduino/ESP)",
      "Sensor dan aktuator dalam IoT",
      "Komunikasi wireless (Wi-Fi, Bluetooth)",
      "Project smart device dan monitoring system",
    ],
  };
